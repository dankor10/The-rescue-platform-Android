...
public class sos extends AppCompatActivity {
    ...
    private void setupMenuListeners() {
        ...
        menuEmergency.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(sos.this, "Переход на страницу МЧС", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(sos.this, MHS.class);
        ...
        menuTrafficPolice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(sos.this, "Переход на страницу ГАИ", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(sos.this, ButtonSOSGAI.class);
                startActivity(intent);
            }
        });
        ...
        menuAmbulance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(sos.this, "Переход на страницу Скорой помощи", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(sos.this, ButtonSOSMed.class);
                startActivity(intent);
            }
        });
        ...
        menuChildren.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(sos.this, "Переход на страницу Мои дети", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(sos.this, Cids.class);
                startActivity(intent);
            }
        });
        ...
        menuHandbook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(sos.this, "Переход в Справочник", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(sos.this, Phone.class);
                startActivity(intent);
            }
        });
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(sos.this, "Переход в профиль", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(sos.this, Accaunt2.class);
                startActivity(intent);
            }
        });
        ...
        writeStatementButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(sos.this, "Переход к написанию заявления", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(sos.this, Zaivlenie.class);
                startActivity(intent);
            }
        });
    ...
    private void cancelCall() {
        ...
        cancelButton.setVisibility(View.GONE);
        emergencyButton.setCardBackgroundColor(ContextCompat.getColor(this, R.color.shazam_dark_gray));
        Toast.makeText(sos.this, "Вызов отменен", Toast.LENGTH_SHORT).show();
    ...
    private void showSuccessMessage() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(sos.this, "Вызов был успешно отправлен!", Toast.LENGTH_LONG).show();
            }
        });
    }
