...
public class AddCids extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_cids);
        ...
        backButton2222.setOnClickListener(v -> startActivity(new Intent(AddCids.this, sos.class)));
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!phoneNumber.isEmpty()) {
                    ...
                    Toast.makeText(AddCids.this, "Введите номер телефона", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        builder.setPositiveButton("Отправить", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!smsCode.isEmpty()) {
                    ...
                    Toast.makeText(AddCids.this, "Введите код из СМС", Toast.LENGTH_SHORT).show();
                }
            }
        });
