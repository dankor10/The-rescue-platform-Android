...
public class MHS extends AppCompatActivity {
    ...
    private void setupMenuListeners() {
        ...
        menuEmergency.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(MHS.this, "Переход на страницу Милиции", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MHS.this, sos.class);
        ...
        menuTrafficPolice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(MHS.this, "Переход на страницу ГАИ", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MHS.this, ButtonSOSGAI.class);
                startActivity(intent);
            }
        });
        ...
        menuAmbulance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(MHS.this, "Переход на страницу Скорой помощи", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MHS.this, ButtonSOSMed.class);
                startActivity(intent);
            }
        });
        ...
        menuChildren.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(MHS.this, "Переход на страницу Мои дети", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MHS.this, Cids.class);
                startActivity(intent);
            }
        });
        ...
        menuHandbook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleMenu();
                Toast.makeText(MHS.this, "Переход в Справочник", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MHS.this, Phone.class);
                startActivity(intent);
            }
        });
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MHS.this, "Переход в профиль", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MHS.this, Accaunt2.class);
                startActivity(intent);
            }
        });
        ...
        writeStatementButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MHS.this, "Переход к написанию объявления", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MHS.this, ProtokolMHS.class);
                startActivity(intent);
            }
        });
    ...
    private void cancelCall() {
        ...
        cancelButton.setVisibility(View.GONE);
        emergencyButton.setCardBackgroundColor(ContextCompat.getColor(this, R.color.shazam_dark_gray));
        Toast.makeText(MHS.this, "Вызов отменен", Toast.LENGTH_SHORT).show();
    ...
    private void showSuccessMessage() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MHS.this, "Вызов был успешно отправлен!", Toast.LENGTH_LONG).show();
            }
        });
    }
